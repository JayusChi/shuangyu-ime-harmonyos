...
- Xiaohe double-pinyin production h*: 3234 records and 3218 unique texts.
...
- ArkTS explicitly requests 9; Rust caps at 9; the production page therefore matches physical selectors 1-9.
