...
5. 按 [0.4.0 AGC 邀请测试上传说明](https://github.com/JayusChi/shuangyu-ime-harmonyos/blob/542ab009c7ada6bbaa57f2f699e24392bd0f5947/artifacts/0.4.0/AGC_UPLOAD_README.md) 完成签名、ARM64 真机和上架资料检查；Release Debug 物理隔离已完成并由门禁持续验证。
