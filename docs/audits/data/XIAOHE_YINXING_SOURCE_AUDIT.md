...
- 阶段状态：**COMPLETED**
- 文件：28（3549882 bytes）
- Manifest SHA-256：`ef93b39e05a0e11c818f8dd837b3f5b2e87777ab02aaba374765a846be7dce55`
- Conversion contract SHA-256：`2353a4b41bd9b1e9aeb1e309cb6ae657078de0d133f624921086f68d82ad8692`
- 不可读取文件：0
- 未识别角色：0
- 阻断原因：none
...
| `小鹤音形/0.2.拼字.txt` | `spelling_resource` | `UTF-8` | `No final newline` | `DEFERRED` |
| `小鹤音形/1.0.分类.txt` | `category_table` | `UTF-8` | `LF` | `ACCEPTED` |
| `小鹤音形/1.2.快符-外接.txt` | `quick_symbol` | `UTF-8` | `CRLF` | `DEFERRED` |
| `小鹤音形/2.1.一简次选.txt` | `one_key_secondary_table` | `UTF-8` | `CRLF` | `TRANSFORM` |
| `小鹤音形/2.2.二简次选.txt` | `two_key_secondary_table` | `UTF-8` | `No final newline` | `TRANSFORM` |
| `小鹤音形/2.3.直通-安卓.txt` | `direct_input` | `UTF-8` | `LF` | `REJECTED` |
| `小鹤音形/2.4.表外字.txt` | `out_of_table_character` | `UTF-8` | `No final newline` | `TRANSFORM` |
| `小鹤音形/2.5.全码词.txt` | `full_code_word` | `UTF-8` | `No final newline` | `TRANSFORM` |
| `小鹤音形/2.6.符号-安卓.txt` | `android_reference` | `Binary / Unknown` | `Binary / Not applicable` | `REJECTED` |
| `小鹤音形/2.6.符号.txt` | `symbol_table` | `UTF-8` | `No final newline` | `TRANSFORM` |
| `小鹤音形/2.7.符号组-安卓.txt` | `android_reference` | `UTF-8` | `LF` | `REJECTED` |
| `小鹤音形/2.7.符号组.txt` | `symbol_group` | `UTF-8` | `LF` | `DEFERRED` |
| `小鹤音形/2.8.生僻字.txt` | `rare_character` | `UTF-8` | `No final newline` | `TRANSFORM` |
| `小鹤音形/2.9.全码字.txt` | `full_code_character` | `UTF-8` | `No final newline` | `TRANSFORM` |
| `小鹤音形/hans2hant.txt` | `simplified_traditional_resource` | `UTF-8` | `LF` | `DEFERRED` |
| `小鹤音形/ime.android.ini` | `configuration_reference` | `UTF-8` | `LF` | `REJECTED` |
...
| `码表/导出 - 主码 - Ｏ符.txt` | `symbol_table` | `UTF-8 with BOM` | `CRLF` | `TRANSFORM` |
